...
namespace Estate.DataAccessLayer.Migrations
{
    ...
    [Migration("20230522070005_UserAdminStatusAdd")]
    partial class UserAdminStatusAdd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Estate.EntityLayer.Entities.Advert", b =>
                {
            ...
            modelBuilder.Entity("Estate.EntityLayer.Entities.City", b =>
                {
                    b.Property<int>("CityId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Estate.EntityLayer.Entities.District", b =>
                {
                    b.Property<int>("DistrictId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Estate.EntityLayer.Entities.GeneralSettings", b =>
                {
            ...
            modelBuilder.Entity("Estate.EntityLayer.Entities.Images", b =>
                {
            ...
            modelBuilder.Entity("Estate.EntityLayer.Entities.Neighbourhood", b =>
                {
                    b.Property<int>("NeighbourhoodId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Estate.EntityLayer.Entities.Situation", b =>
                {
                    b.Property<int>("SituationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Estate.EntityLayer.Entities.Type", b =>
                {
                    b.Property<int>("TypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Estate.EntityLayer.Entities.UserAdmin", b =>
                {
            ...
            modelBuilder.Entity("Estate.EntityLayer.Entities.Advert", b =>
                {
                    b.HasOne("Estate.EntityLayer.Entities.Neighbourhood", "Neighbourhood")
                        .WithMany()
                        .HasForeignKey("NeighbourhoodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Estate.EntityLayer.Entities.Type", "Type")
                        .WithMany("Adverts")
                        .HasForeignKey("TypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Estate.EntityLayer.Entities.UserAdmin", "UserAdmin")
                        .WithMany("Adverts")
            ...
            modelBuilder.Entity("Estate.EntityLayer.Entities.District", b =>
                {
                    b.HasOne("Estate.EntityLayer.Entities.City", "City")
                        .WithMany("Districts")
            ...
            modelBuilder.Entity("Estate.EntityLayer.Entities.Images", b =>
                {
                    b.HasOne("Estate.EntityLayer.Entities.Advert", "Advert")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("Estate.EntityLayer.Entities.Neighbourhood", b =>
                {
                    b.HasOne("Estate.EntityLayer.Entities.District", "District")
            ...
            modelBuilder.Entity("Estate.EntityLayer.Entities.Type", b =>
                {
                    b.HasOne("Estate.EntityLayer.Entities.Situation", "Situation")
                        .WithMany("Types")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Estate.EntityLayer.Entities.UserAdmin", null)
                        .WithMany()
